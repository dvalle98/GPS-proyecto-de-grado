 ...
 */
SPIDeviceDV::SPIDeviceDV(int8_t cspin, uint32_t freq,
 ...
 *    @param  dataMode The SPI mode to use, defaults to SPI_MODE0
 */
SPIDeviceDV::SPIDeviceDV(int8_t cspin, int8_t sckpin,
 ...
 */
void SPIDeviceDV::transfer(uint8_t *buffer, size_t len) {
  //
  // HARDWARE SPI
  //
  if (_spi) {
 ...
 */
uint8_t SPIDeviceDV::transfer(uint8_t send) {
  uint8_t data = send;
  transfer(&data, 1);
  return data;
}
 ...
 * SPI)
 */
void SPIDeviceDV::beginTransaction(void) {
  if (_spi) {
#ifdef BUSIO_HAS_HW_SPI
 ...
 */
void SPIDeviceDV::endTransaction(void) {
  if (_spi) {
#ifdef BUSIO_HAS_HW_SPI
    _spi->endTransaction();
#endif
 ...
 */
void SPIDeviceDV::setChipSelect(int value) {
  if (_cs != -1) {
 ...
 */
void SPIDeviceDV::beginTransactionWithAssertingCS() {
  beginTransaction();
  setChipSelect(LOW);
}
 ...
 */
void SPIDeviceDV::endTransactionWithDeassertingCS() {
  setChipSelect(HIGH);
  endTransaction();
}
 ...
 * writes
 */
bool SPIDeviceDV::write(const uint8_t *buffer, size_t len,
 ...
 * writes
 */
bool SPIDeviceDV::read(uint8_t *buffer, size_t len, uint8_t sendvalue) {
 ...
 * writes
 */
bool SPIDeviceDV::write_then_read(const uint8_t *write_buffer,
 ...
 * writes
 */
bool SPIDeviceDV::write_and_read(uint8_t *buffer, size_t len) {
  beginTransactionWithAssertingCS();
  transfer(buffer, len);
  endTransactionWithDeassertingCS();
